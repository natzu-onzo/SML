...
(*
	val test_totalDistance_01 = epsilon(totalDistance(cphMarathon2014), 42.9686446838)
	val test_totalDistance_02 = epsilon(totalDistance([(55.66639000,12.57621000)]), 0.0)
	val test_totalDistance_03 = (totalDistance([]); false) handle Empty => true | _ => false
*)
...
fun speeds ((p1, t1)::(p2, t2)::c) = [distance(p1, p2) / ms2Hour(t2 - t1)] @ speeds((p2, t2)::c)
  | speeds [_]	 	    		   = []
  | speeds []					   = raise Empty;
...
(*
	...
	val test_averageAll_02 = (averageAll([]); false) handle Empty => true | _ => false
*)
...
(*
	val test_averageSpeed_01 = (averageSpeed([]); false) handle Empty => true | _ => false
	val test_averageSpeed_02 = epsilon(averageSpeed(storebaelt), 13.9886997339)
	val test_averageSpeed_03 = (averageSpeed([((1.0, 1.0), 0)]); false) handle Domain => true | _ => false
*)
